...
import "C:/dev/react/0731/src/Sass/FeedItem.scss";
      ...
      <div className="feed-item">
        <div className="feedHeader">
          ...
          <div className="feedTitle">
            <div className="feedTitlename">{this.props.name}</div>
            <div className="feedTitletime">{this.props.time}</div>
          </div>
        </div>
        <div className="feedContent">
          안녕 여러분 여기가 페이스북이구나랄라랄
        </div>
